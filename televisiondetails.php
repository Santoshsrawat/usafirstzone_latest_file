...
$sql = "SELECT * FROM television WHERE model = ?";
...
if ($stmt->execute()) {
        ...
        <div class="front-product ">
            ...
            <div class="row first-row ">
                <div class="col-lg-9 col-md-6 col-sm-6  col-xs-6 d-flex product-section">
                    <a href=""><span>Television</span><i class="fa-solid fa-chevron-right"></i><span>Led Tv </span><i
                            class="fa-solid fa-chevron-right"></i><span><?php echo $row['brand']; ?></span></a>
                </div>
            ...
            <div class="row second-row ">
                ...
                <div class="short-list">
                    <div class="">
                        <a href="" class="big"><?php echo $row["brand"];
        echo $row["model"] ?></a>
                    </div>
    ...
    .slideshow-image {
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 phone-container">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides ">
                            ...
                            <img src="television_images/<?php echo $row['image']; ?>" alt="<?php echo $row['model']; ?>" class="slideshow-image">
                            <!-- <div class="text">Caption Text</div> -->
                        </div>

                        <div class="mySlides">
                            <div class="whislist"><a href=""><i class="fa-regular fa-heart"></i></a></div>
                     <img src="television_images/<?php echo $row['image1']; ?>" alt="<?php echo $row['model']; ?>" class="slideshow-image">
                            <!-- <div class="text">Caption Two</div> -->
                        </div>

                        <div class="mySlides">
                            <div class="whislist"><a href=""><i class="fa-regular fa-heart"></i></a></div>
                     <img src="television_images/<?php echo $row['image2']; ?>" alt="<?php echo $row['model']; ?>" class="slideshow-image">
                        ...
                        <div class="dots-section">
                            <img src="television_images/<?php echo $row['image']; ?>"  alt="" class="dot" onclick="currentSlide(1)">
                            <img src="television_images/<?php echo $row['image1']; ?>"  alt="" class="dot" onclick="currentSlide(2)">
                            <img src="television_images/<?php echo $row['image2']; ?>"  alt="" class="dot" onclick="currentSlide(3)">
                        </div>
                    </div>
                </div>
                    ...
                    <div class="description-product">
                        ...
                        <div class="row" s>
                            <div class="col-lg-3 col-md-6 col-sm-6 description-box">
                                ...
                                <ul>
                                   <?php echo $row["resolution"] . "<br>" ?>
                                   <?php echo $row["type"] . "<br>" ?>
                                   <?php echo $row["refresh_rate"] . "<br>" ?>
                                   <?php echo $row["dimensions_without"] . "<br>" ?>
        ...
        <div class="front-product-2 front-product">
            <h2><span>RECENTLY VIEWED & RECOMMENDED PRODUCTS</span><a href="televisionfinder.php">View All</a></h2>

            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="row ">
                            <a class="col-lg-4 col-md-4 col-sm-12 product-compare" href="televisiondetails.php">
                                <img src="images/television/tv.png" alt="">
                                <div class="proudct-box">
                                    <p>Xioami42 Inches LED Tv</p>
                    ...
                    <div class="carousel-item">
                        <div class="row ">
                            <div class="col-lg-4 col-md-4 col-sm-12 product-compare" href="televisiondetails.php">
                                <img src="images/television/tv.png" alt="">
                                <div class="proudct-box">
                                    <p>Xioami42 Inches LED Tv</p>
                                    <span><i class="fa-solid fa-dollar-sign"></i> 100</span><br />
...
<?php
        ...
        echo "television not found"; // This means no results were found
    }
} else {
