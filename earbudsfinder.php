...
if (isset($_GET['brand'])) {
    ...
    $sql = "SELECT * FROM earbuds WHERE brand = '$selectedBrand'";
} else {
    // If no brand is selected, fetch all earbuds models
...
?>
                <div class="col-lg-9 col-md-6 col-sm-12 phone-details-section">
                    ...
                    <?php
$earbudsModel = $row["model"];
    $earbudsImage = 'earbuds_images/' . $row["images"];
    ?>
                   <div class="phone-details-container">
            <!-- -- phone image - -->
            <div class="phone-image">
              <img src="<?php echo $earbudsImage; ?>" alt="<?php echo $earbudsModel; ?>" />
            ...
            <div class="name-box-container">
              ...
              <div class="name-box">
                <div class="box-content-left">
                  <a href="earbudsdetails.php?model=<?php echo urlencode($earbudsModel); ?>">
                    <h2>
                      <?php echo $earbudsModel; ?>
                    </h2>
                </div>
