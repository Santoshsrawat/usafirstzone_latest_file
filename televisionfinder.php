...
?>
  ...
  <main>
    ...
    <div class="phone-finder border-2" style="padding: 10px 20px">
      <h2>Laptop Finder</h2>
      <p>
        Confused about which laptop to buy? Just feed in your requirements to
        our Laptop Finder and you will get best recommendations. Start your
        search now.
      </p>
    </div>
    <!-----   phone-finder end   ------>
            ...
            <div class="product-filter">
              ...
              <div class="filter-section">
                <form action="">
                  <div>
                    <input type="checkbox" />
                    <label for="">24 Inch - 32 Inch </label>
                  </div>
                  <div>
                    <input type="checkbox" />
                    <label for="">32 Inch - 43 Inch</label>
                  </div>
                  <div>
                    <input type="checkbox" />
                    <label for="">43 Inch - 55 Inch</label>
                  </div>
                  <div>
                    <input type="checkbox" />
                    <label for="">55 Inch - 65 Inch</label>
                  </div>
                  <div>
                    <input type="checkbox" />
                    <label for="">75 Inch & Above </label>
                  </div>
                </form>
              </div>
              <!-- ---- -->
              ...
              <div class="filter-section">
                <form action="">
                  ...
                  <div>
                    <input type="checkbox" />
                    <label for="">Hisense</label>
                  </div>
                  <div>
                    <input type="checkbox" />
                    <label for="">Insignia</label>
                  </div>
                  <div>
                    <input type="checkbox" />
...
if (isset($_GET['brand'])) {
    ...
    $sql = "SELECT * FROM television WHERE brand = '$selectedBrand'";
} else {
    // If no brand is selected, fetch all television models
...
?>
        ...
        <div class="col-lg-9 col-md-6 col-sm-12 television-details-section">
          <?php if ($result->num_rows > 0) {?>
          <?php while ($row = $result->fetch_assoc()) {?>
          <?php
            $televisionModel = $row["model"];
           $televisionImage = 'television_images/' . $row["image"];
              ?>
          <div class="phone-details-container">
            <!-- -- phone image - -->
            <div class="phone-image">
              <img src="<?php echo $televisionImage; ?>" alt="<?php echo $televisionModel; ?>" />
            ...
            <div class="name-box-container">
              ...
              <div class="name-box">
                <div class="box-content-left">
                  <a href="televisiondetails.php?model=<?php echo urlencode($televisionModel); ?>">
                    <h2>
                      <?php echo $televisionModel; ?>
                    </h2>
                </div>
    ...
    <div class="front-product-2 front-product" style="border: 2px solid #ccc; margin-bottom: 20px">
      <h2>
        <span>RECENTLY VIEWED & RECOMMENDED PRODUCTS</span><a href="">View All</a>
      </h2>
