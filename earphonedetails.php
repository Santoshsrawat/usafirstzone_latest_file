...
$sql = "SELECT * FROM earphones WHERE model = ?";
...
if ($stmt->execute()) {
        ...
        <div class="front-product ">
            ...
            <div class="row first-row ">
                <div class="col-lg-9 col-md-6 col-sm-6  col-xs-6 d-flex product-section">
                    <a href=""><span>Earphones</span><i class="fa-solid fa-chevron-right"></i><span><?php echo $row["brand"]; ?> Earphones </span><i
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 phone-container">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides ">
                            ...
                            <img src="earphones_images/<?php echo $row['image']; ?>" alt="<?php echo $row['model']; ?>" class="slideshow-image">
                            <!-- <div class="text">Caption Text</div> -->
                        </div>

                        <div class="mySlides">
                            <div class="whislist"><a href=""><i class="fa-regular fa-heart"></i></a></div>
                            <img src="earphones_images/<?php echo $row['image1']; ?>" alt="<?php echo $row['model']; ?>" class="slideshow-image">
                            <!-- <div class="text">Caption Two</div> -->
                        </div>

                        <div class="mySlides">
                            <div class="whislist"><a href=""><i class="fa-regular fa-heart"></i></a></div>
                            <img src="earphones_images/<?php echo $row['image2']; ?>" alt="<?php echo $row['model']; ?>" class="slideshow-image">
                        ...
                        <div class="dots-section">
                            <img src="earphones_images/<?php echo $row['image']; ?>"  alt="" class="dot" onclick="currentSlide(1)">
                            <img src="earphones_images/<?php echo $row['image1']; ?>"  alt="" class="dot" onclick="currentSlide(2)">
                            <img src="earphones_images/<?php echo $row['image2']; ?>"  alt="" class="dot" onclick="currentSlide(3)">
                        </div>
                    </div>
                </div>
                <style>
    .slideshow-image {
                        ...
                        <div class="row" s>
                            <div class="col-lg-3 col-md-6 col-sm-6 description-box">
                                ...
                                <ul>
                                   ...
                                   <?php echo $row["microphone"] . "<br>" ?>
                                   <?php echo $row["open_or_closed_back"] . "<br>" ?>
                                   <?php echo $row["foldable_design"] . "<br>" ?>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 description-box">
                                ...
                                <ul>
                                <?php echo $row["compatible_models"] . "<br>" ?>
                                </ul>
                            </div>
                            <!----   description-box ----->
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 description-box">
                                ...
                                <ul>
                                <?php echo $row["bluetooth_version"] . "<br>" ?>
                                </ul>
                            </div>
                            <!----   description-box ----->
        ...
        <div class="front-product-2 front-product">
            <h2><span>RECENTLY VIEWED & RECOMMENDED PRODUCTS</span><a href="earphonefinder.php">View All</a></h2>
            ...
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="row ">
                            <a class="col-lg-4 col-md-4 col-sm-12 product-compare" href="earphonedetails.php">
                                <img src="earphones_images/<?php echo $row['image']; ?>"  alt="">
                    ...
                    <div class="carousel-item">
                        <div class="row ">
                            <div class="col-lg-4 col-md-4 col-sm-12 product-compare" href="earphonedetails.php">
                                <img src="earphones_images/<?php echo $row['image']; ?>"  alt="">
                                <div class="proudct-box">
                                    <p>Vivo Y21</p>
                                    <span><i class="fa-solid fa-dollar-sign"></i> 100</span><br />
        ...
        <div class="front-product front-product-4" id="front-product-4">
            <h2><span>Details</span><a href="earphonesfinder.php">View All</a></h2>
            <!-- === -->
            <?php
...
<?php
        ...
        echo "earphones not found"; // This means no results were found
    }
} else {
