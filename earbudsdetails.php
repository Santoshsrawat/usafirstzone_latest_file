...
$sql = "SELECT * FROM earbuds WHERE model = ?";
...
if ($stmt->execute()) {
    ...
    <main>
        <div class="front-product ">
            ...
            <div class="row first-row ">
                <div class="col-lg-9 col-md-6 col-sm-6  col-xs-6 d-flex product-section">
                    <a href=""><span>Earbuds</span><i class="fa-solid fa-chevron-right"></i><span><?php echo $row["brand"]; ?> Earbuds </span><i
        ...
        echo $row["model"] ?></a>
                ...
                <!-- ----  -->
                <div class="col-lg-12">
                    <a href="" class="para">Market status: Available in USA </a>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6 phone-container">
                    <div class="slideshow-container">
                        ...
                        <div class="mySlides ">
                            ...
                            <img src="earbuds_images/<?php echo $row['images']; ?>" alt="<?php echo $row['model']; ?>" class="slideshow-image">
                            <!-- <div class="text">Caption Text</div> -->
                        </div>

                        <div class="mySlides">
                            <div class="whislist"><a href=""><i class="fa-regular fa-heart"></i></a></div>
                            <img src="earbuds_images/<?php echo $row['image1']; ?>" alt="<?php echo $row['model']; ?>" class="slideshow-image">
                            <!-- <div class="text">Caption Two</div> -->
                        </div>

                        <div class="mySlides">
                            <div class="whislist"><a href=""><i class="fa-regular fa-heart"></i></a></div>
                            <img src="earbuds_images/<?php echo $row['image2']; ?>" alt="<?php echo $row['model']; ?>" class="slideshow-image">
                        ...
                        <div class="dots-section">
                            <img src="earbuds_images/<?php echo $row['images']; ?>"  alt="" class="dot" onclick="currentSlide(1)">
                            <img src="earbuds_images/<?php echo $row['image1']; ?>"  alt="" class="dot" onclick="currentSlide(2)">
                            <img src="earbuds_images/<?php echo $row['image2']; ?>"  alt="" class="dot" onclick="currentSlide(3)">
                        </div>
                    </div>
                </div>
                <style>
    .slideshow-image {
        ...
        <div class="front-product-2 front-product">
            <h2><span>RECENTLY VIEWED & RECOMMENDED PRODUCTS</span><a href="earbudsfinder.php">View All</a></h2>

            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="row ">
                            <a class="col-lg-4 col-md-4 col-sm-12 product-compare" href="earbudsdetails.php">
                                <img src="images/wearables/earbuds.png" alt="">
                    ...
                    <div class="carousel-item">
                        <div class="row ">
                            <div class="col-lg-4 col-md-4 col-sm-12 product-compare" href="earbudsdetails.php">
                                <img src="images/wearables/earbuds.png" alt="">
                                <div class="proudct-box">
                                    <p>Vivo Y21</p>
                                    <span><i class="fa-solid fa-dollar-sign"></i> 100</span><br />
