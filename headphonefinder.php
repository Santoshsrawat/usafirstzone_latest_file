...
?>
    ...
    <main>
        ...
        <div class="phone-finder  border-2" style="padding:10px 20px;">
            <h2>Laptop Finder</h2>
            <p>Confused about which laptop to buy? Just feed in your requirements to our Laptop Finder and you will get best recommendations. Start your search now.</p>
        </div>
        <!-----   phone-finder end   ------>
                        ...
                        <div class="product-filter">
                            ...
                            <div class="filter-section-1">
                                <form action="">
                                    ...
                                    <div>
                                        <input type="radio">
                                        <label for="">$ 133 and below</label>
                                    </div>
                                    <div>
                                        <input type="radio">
                                        <label for="">$ 201 and below</label>
                                    </div>
                                    <div>
                                        <input type="radio">
                                        <label for="">$ 301 and below</label>
                                    </div>
                                    <div>
                                        <input type="radio">
                                        <label for="">$ 371 and below</label>
                                    </div>
                                    <div>
                                        <input type="radio">
                                        <label for="">$ 501 and below</label>
                                    </div>
...
if (isset($_GET['brand'])) {
    ...
    $sql = "SELECT * FROM headphones WHERE brand = '$selectedBrand'";
} else {
    // If no brand is selected, fetch all headphones models
...
?>
                ...
                <div class="col-lg-9 col-md-6 col-sm-12 phone-details-section">
                    ...
                    <?php
$headphonesModel = $row["model"];
    $headphonesImage = 'headphones_images/' . $row["image"];
    ?>
                   <div class="phone-details-container">
            <!-- -- phone image - -->
            <div class="phone-image">
              <img src="<?php echo $headphonesImage; ?>" alt="<?php echo $headphonesModel; ?>" />
            ...
            <div class="name-box-container">
              ...
              <div class="name-box">
                <div class="box-content-left">
                  <a href="headphonedetails.php?model=<?php echo urlencode($headphonesModel); ?>">
                    <h2>
                      <?php echo $headphonesModel; ?>
                    </h2>
                </div>
            ...
            <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="row ">
                            <a class="col-lg-4 col-md-4 col-sm-12 product-compare" href="headphonefinder.php">
