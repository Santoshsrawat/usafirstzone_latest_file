...
$sql = "SELECT * FROM android WHERE model = ?";
        ...
        <div class="front-product ">
            ...
            <div class="row first-row ">
                <div class="col-lg-9 col-md-6 col-sm-6  col-xs-6 d-flex product-section">
                    <a href=""><span>Mobiles</span><i class="fa-solid fa-chevron-right"></i><span><?php echo $row['brand']; ?> Mobile </span><i
            ...
            <div class="row second-row ">
                ...
                <div class="short-list">
                    <div class="">
                        <a href="" class="big">  <?php echo $row['model']; ?></a>
                    </div>
    ...
    <div class="col-lg-4 col-md-6 col-sm-6 phone-container">
        <div class="slideshow-container">
            ...
            <div class="mySlides">
                ...
                <img src="android_images/<?php echo $row['image']; ?>" alt="<?php echo $row['model']; ?>" class="slideshow-image">
            </div>

            <div class="mySlides">
                <div class="whislist"><a href=""><i class="fa-regular fa-heart"></i></a></div>
                <img src="android_images/<?php echo $row['image2']; ?>" alt="<?php echo $row['model']; ?>" class="slideshow-image">
            </div>

            <div class="mySlides">
                <div class="whislist"><a href=""><i class="fa-regular fa-heart"></i></a></div>
                <img src="android_images/<?php echo $row['image3']; ?>" alt="<?php echo $row['model']; ?>" class="slideshow-image">
            </div>
            ...
            <div class="dots-section">
                <img src="android_images/<?php echo $row['image1']; ?>" alt="<?php echo $row['model']; ?>" class="dot" onclick="currentSlide(1)">
                <img src="android_images/<?php echo $row['image2']; ?>" alt="<?php echo $row['model']; ?>" class="dot" onclick="currentSlide(2)">
                <img src="android_images/<?php echo $row['image3']; ?>" alt="<?php echo $row['model']; ?>" class="dot" onclick="currentSlide(3)">
            </div>
        </div>
    </div>
                ...
                <div class="col-lg-8 col-md-6 col-sm-6">
                    <div class="web-link">
                        ...
                        <div class="content-box">
                            ...
                            <button><a href="<?php echo $row['affiliate_links']; ?>" target="blank">Go to Store</a></button>
                        </div>
                    </div>
                    <div class="web-link">
                    ...
                    <div class="storage-container ">
                        <div class="storage">
                            <p><i class="fa-solid fa-sd-card"></i> <span><?php echo $row['internal_memory']; ?></span></p>
                            <p><i class="fa-solid fa-wifi"></i> <span><?php echo $row['wifi']; ?></span></p>
                            <p><i class="fa-brands fa-usb"></i> <span><?php echo $row['audio_jack']; ?></span></p>
                        </div>
                        <!-- --- -->
                        <div class="storage">
                            <p><i class="fa-solid fa-sim-card"></i> <span><?php echo $row['sim(slots)']; ?></span></p>
                            <p><i class="fa-solid fa-fingerprint"></i> <span><?php echo $row['fingerprint_sensor_position']; ?></span></p>

                        </div>
                        <!-- --- -->
                        <div class="storage">
                            <p><i class="fa-solid fa-mobile"></i> <span><?php echo $row['screen_protection']; ?></span></p>
                            <p><i class="fa-solid fa-signal"></i> <span><?php echo $row['network_support']; ?></span></p>
                        </div>
                    </div>
                </div>
            </div>
...
// Initialize variables to build the HTML structure
        ...
        foreach ($row as $key => $value) {
            ...
            if ($key === "id" || $key === "model" || $key === "mobile_category" || strpos($key, 'image') !== false || $key === "affiliate_links") {
                continue;
            }
            ...
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="product-compare-2">
                        ...
                        <!-----  after add compare --- -->
                        <div class="after-add-compare" id="after-add-compare">
                            <a href="" id="remove-compare" onclick="removeCompare(2)"><i
                                    class="fa-solid fa-xmark"></i></a>
                            <div class="compare-details">
                                <img src="images/mobiles/vivo-2.png" alt="">
                                <h3>Vivo Y17S</h3>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6">
                    <div class="product-compare-2">
                        ...
                        <!-----  after add compare --- -->
                        <div class="after-add-compare" id="after-add-compare">
                            <a href="" id="remove-compare" onclick="removeCompare(3)"><i
                                    class="fa-solid fa-xmark"></i></a>
                            <div class="compare-details">
                                <img src="images/mobiles/vivo-2.png" alt="">
                                <h3>Vivo Y17S</h3>
...
<?php
        ...
        echo "Mobile not found"; // This means no results were found
    }
} else {
